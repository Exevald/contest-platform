    ...
    const logs = [
        {
            severity: 'CRITICAL',
            tone: 'error' as const,
            payload: 'sourceIp=10.0.0.1, userId=db_user, eventType=SQL_INJECTION'
        },
        {
            severity: 'HIGH',
            tone: 'warning' as const,
            payload: 'sourceIp=192.168.1.50, userId=alice, eventType=Brute Force'
        },
        {
            severity: 'MEDIUM',
            tone: 'neutral' as const,
            payload: 'sourceIp=172.16.0.8, userId=ops, eventType=failed login'
        },
    ]
            ...
            <div className={styles.metricsGridWide}>
                ...
                <Card className={styles.rulesCard}>
                    ...
                    <div className={styles.simRow}>
                        ...
                        <div className={styles.metricTrack}>
                            <div className={styles.metricFillGood} style={{width: '96%'}}/>
                        </div>
                    </div>
                    <div className={styles.simRow}>
                        <span>Legitimate Dropped</span>
                        <div className={styles.metricTrack}>
                            <div className={styles.metricFillLow} style={{width: '2%'}}/>
                        </div>
                    </div>
                </Card>
            </div>
